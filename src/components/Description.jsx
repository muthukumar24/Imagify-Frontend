  ...
  return (
    <div className='flex flex-col items-center justify-center my-24 p-6 md:px-28'>
        ...
        <div>
          ...
          <div>
            <h2>Intorducing the AI Powered Text to Image Generator</h2>
            <p>
            ...
            <p>
              ...
              will generate high quality images in seconds. From product visuals 
              to character designs and portraits, even concepts that dont't yet 
              exist can be visualized effortlessly. Powered by advanced AI technology,
